...
if ($argc<2) {
	help();
	exit(); //OJO CUANDO NO PONGO ARGUMENTOS ME DEVUELVE DOS HELPS LE PUEDO METER UN EXIT
}
}
...
switch ($action) {
	...
	case ACTION_4:
		...
		break;
	default:
		help();  #Creo que el probelma se soluciona aquí cuando no llame dos veces al help.
